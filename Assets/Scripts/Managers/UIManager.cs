...
public class UIManager : Singleton<UIManager> {
    ...
    public void ShowTooltip(ItemDetails itemDetails, Vector2 position) {
        ...
        tooltip.transform.position = new(position.x, position.y, 0);
        ...
        tooltip.transform.Find("Wrapper").Find("Description").GetComponent<TextMeshProUGUI>().text
            = "Description:\n  " + ((itemDetails.description == "" || itemDetails.description == null)? "<null>" : itemDetails.description);
